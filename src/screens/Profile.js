...
import { View, Text, Pressable, ScrollView, Dimensions, Keyboard } from 'react-native';
import { List, Snackbar } from 'react-native-paper';
import { Plus, User, PersonArmsSpread, Rabbit, Bird, Butterfly, Cat, Cow, Dog, FishSimple, Horse, X, CaretRight, SignOut, NotePencil } from 'phosphor-react-native';
        ...
        <View style={{width: '100%', gap: 20, paddingVertical: 12}}>
          ...
          >
            ...
            <Pressable 
              ...
              onPress={() => {openBottomSheet(); setBottomSheetTitle('Choose your avatar');}}
            >
              <NotePencil size={28} color={COLORS.grey500}/>
            </Pressable>
          </Pressable>
